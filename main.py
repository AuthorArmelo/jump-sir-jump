...
HEIGHT = 500
background = white
player = pygame.transform.scale(pygame.image.load('player.png.jpg'), (90, 70))
fps = 60
...
pygame.display.set_caption('jump sir jump!')
...
while running == True:
    ...
    if x_change > 0:
        ...
        player = pygame.transform.flip(pygame.transform.scale(pygame.image.load('player.png.jpg'), (90, 70)), 1, 0)
